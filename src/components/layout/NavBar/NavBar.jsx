  ...
  return (
    <div className="max-w-fit">
       <ul className=" hidden sm:flex sm:justify-center sm:space-x-20 sm:mt-5">
        ...
        <li>
            <a className="sm:text-xl sm:font-semibold md:text-2xl lg:text-3xl" href="">About</a>
        </li>
        <li>
            <a className="sm:text-xl sm:font-semibold md:text-2xl lg:text-3xl" href="">Products</a>
        </li>
        <li>
            <a className="sm:text-xl sm:font-semibold md:text-2xl lg:text-3xl" href="">Contact Us</a>
        </li>
        </div>
       </ul>
